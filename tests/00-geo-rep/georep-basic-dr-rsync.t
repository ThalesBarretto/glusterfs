...
TEST ! $GEOREP_CLI $primary $secondary config ssh-port abc

TEST ! $GEOREP_CLI $primary $secondary config ssh-port 6875943

TEST ! $GEOREP_CLI $primary $secondary config ssh-port 4.5

TEST ! $GEOREP_CLI $primary $secondary config ssh-port 22a
