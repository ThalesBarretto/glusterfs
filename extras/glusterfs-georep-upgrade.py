        ...
        with open(htime_file_path, 'r') as htime_file, open(temp_htime_path, 'w') as temp_htime_file:
            ...
            for pth in paths:
                ...
                if changelog.startswith("CHANGELOG."):
                    ...
                    # copy existing changelogs to new directory structure,
...
if __name__ == "__main__":
    ...
    parser.add_argument('brick_path',
                        help="This upgrade script, which is to be run on\
                        server side, takes brick path as the argument, \
                        updates paths inside htime file and alters the \
                        directory structure above the changelog files in \
                        order to support new optimised format of the  \
                        directory structure as per \
